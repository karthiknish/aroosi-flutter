...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _selectBirthDate() async {
    ...
    if (picked != null && context.mounted) {
      ...
      if (actualAge < 18) {
        ToastService.instance.warning('You must be at least 18 years old to use Aroosi');
        _birthDate.clear();
      } else {
        setState(() {
          _birthDate.text =
                  ...
                  onPressed: auth.loading
                      ...
                      : () {
                          ...
                          if (_name.text.trim().isEmpty) {
                            ToastService.instance.warning('Please enter your name');
                            return;
                          }

                          if (_email.text.trim().isEmpty ||
                              !_email.text.contains('@')) {
                            ToastService.instance.warning('Please enter a valid email address');
                            return;
                          }

                          if (_password.text.length < 6) {
                            ToastService.instance.warning('Password must be at least 6 characters');
                            return;
                          }

                          if (_birthDate.text.isEmpty) {
                            ToastService.instance.warning('Please enter your date of birth');
                            return;
                          }
